# [Font Awesome v4.7.0](https://fontawesome.io) [![Changelog #226](https://img.shields.io/badge/changelog-%23226-9E978E.svg)](https://changelog.com/podcast/226)
...
- Ruby Development Headers
  ...
  - **Windows:** [DevKit](https://rubyinstaller.org/)
- [Bundler](https://bundler.io/) (Run `gem install bundler` to install).
- [Node Package Manager (AKA NPM)](https://docs.npmjs.com/getting-started/installing-node)
- [Less](https://lesscss.org/) (Run `npm install -g less` to install).
