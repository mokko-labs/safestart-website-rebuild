...
/*	ADVISORY SELECTOR
 /*-----------------------------------------------------------------------------------*/
jQuery(document).ready(function () {
    jQuery(".advisory-item").click(function () {
        var advisoryno = $(this).data('advisoryno');
        jQuery('#advisory-1').hide();
        jQuery('#advisory-2').hide();
        jQuery('#advisory-3').hide();
...
$(document).ready(function () {
    ...
    owl.owlCarousel({
        ...
        navigation: true,
        pagination: false,
        navigationText: ["<img src='images/slider/testimonials_right.png'>", "<img src='images/slider/testimonials_left.png'>"],
        items: 1,
        itemsDesktop: [600, 2]
    });
