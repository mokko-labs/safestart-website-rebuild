...
export const metadata: Metadata = {
  ...
  title: "Hospitals",
  description:
    "SafeStart helps hospitals and healthcare systems eliminate Never Events, improve operating room throughput, and engage patients in the surgical safety process.",
};
...
const benefits = [
  ...
  {
    title: "Improved Portal Usage",
    lead: "SafeStart can drive EMR patient portal usage by delivering critical patient safety information.",
    bullets: [
      "Leverage hospital investment in multi-million dollar EMR investments",
      "Drive patient portal registrations",
      "Drive ongoing patient portal usage for patients to view the completed operating room surgical safety checklist",
    ],
  },
  {
    ...
    bullets: [
      ...
      "Ask us about ChartNote for AI scribed note writing. Works with or without EMR.",
    ],
  },
  {
          ...
          <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6">
            <div className="grid gap-6 md:grid-cols-[minmax(0,1fr)_minmax(0,2fr)] md:gap-12">
              ...
              <div>
                ...
                <ul className={benefit.lead ? "mt-6 space-y-3" : "space-y-3"}>
